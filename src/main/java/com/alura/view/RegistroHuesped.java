...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Reserva reserva) {
		...
		//	Reserva textField
		txtNreserva = new JTextField(String.valueOf(reserva.getId()));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Huesped huesped = new Huesped(	txtNombre.getText(), txtApellido.getText(), txtNacionalidad.getSelectedItem().toString(), 
												txtFechaN.getDate(), txtTelefono.getText(), reserva.getId());
			
				/*System.out.println("\n RegistroHuespedes");
				System.out.println("Nombre: "+ huesped.getNombre());
				System.out.println("Apellido: "+ huesped.getApellido());
				System.out.println("Fecha Nacimiento: "+ huesped.getFechaNacimiento().toString());
				...
				try {
					...
					if(dataBase.createReserva(reserva).equals("si") && dataBase.createHuesped(huesped).equals("si")) {
				...
				System.out.println("Fecha Nacimiento: "+txtFechaN.getDate().toString());
				System.out.println("Nacionalidad: "+txtNacionalidad.getSelectedItem().toString());
